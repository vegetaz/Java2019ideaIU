        ...
        for (int i = 0; i < a.length; i++) {
            ...
            switch (choice) {
                case 1://nhan vien san xuat
                    ...
                    //xoa bo dem
                    sn.nextLine();
                    a[i] = new NhanVienSanXuat(ssp, name, nvl);
                    break;
                case 2://nhan vien van phong
                    ...
                    int snn = sn.nextInt();
                    sn.nextLine();
                    a[i] = new NhanVienVanPhong(ml, snn, name, nvl);
                    break;
            }
        }
    ...
    public void xuat() {
        ...
        for (int i = 0; i < a.length; i++) {
            if (a[i] instanceof NhanVienSanXuat) {
                System.out.printf("\n%25s%20d%20.2f%20.2f%20.2f", a[i].getHoTen(), a[i].getNamVaoLam(),
                        a[i].tinhLuong(), a[i].tinhThuong(), a[i].tinhLuong() + a[i].tinhThuong());
            }
        }
